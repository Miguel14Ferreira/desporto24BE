...
public class FileConstant {
    ...
    public static final String USER_FOLDER = System.getProperty("user.home") + "/desporto24/user/";
    public static final String DIRECTORY_CREATED = "Created directory for:";
    public static final String DEFAULT_USER_IMAGE_PATH = "/api/auth/image/profile/";
